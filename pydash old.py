...
vel = 7.071
vel = 14.142
vel2 = 14.142  # do not delete vel2
...
while run:
    ...
    # eh i'll fix the mini wave trail later but for the normal wave, we got it fixed and working now!
    ...
    # if mini:
    # player = window.blit(mwaveimg, (x - 11, y - 12))
    # print("MINI")

    # minic = minic - 1
    # if minic == 2 and mini:
    # mwaveimg = pygame.transform.rotate(mwaveimg, 122.5)
    # print("22")
    # minic = minic - 2
    ...
    # pygame.draw.rect(window, (255,0,0), (a+300, 250, 300, 300))
    # pygame.draw.rect(window, (255,0,0), (a, 540, 300, 300))

    # if a < 1:
    # a = c

    # de = pygame.draw.rect(window, (255, 0, 0), (a + 300, 250, 50, 50))
    # de = pygame.draw.rect(window, (255, 0, 0), (a + 400, 350, 50, 50))

    # de = pygame.draw.rect(window, (255, 0, 0), (a + 700, 100, 50, 50))
    # de = pygame.draw.rect(window, (255, 0, 0), (a + 900, 500, 50, 50))

    # if pygame.sprite.collide_mask(ed, de):
    # print("ded LLLLLLLLLL")

    # pygame.draw.rect(window, (255,0,0), (a, 540, 300, 300))
    # if a < 1:
    # a = c

    # pygame.draw.rect(window, (255,0,0), (a+200, b-200, width+10, length+200))
    # if a < 1:
    # a = c
    # pygame.draw.rect(window, (255,0,0), (a+300, b-540, width+10, length+200))
    # if a < 1:
    # a = c
    # pygame.draw.rect(window, (255,0,0), (a+400, b-200, width+10, length+200))
    # if a < 1:
    # a = c
    # pygame.draw.rect(window, (255,0,0), (a+500, b-540, width+10, length+200))
    # if a < 1:
    # a = c
    # pygame.draw.rect(window, (255,0,0), (a+600, b-200, width+10, length+200))
    # if a < 1:
    # a = c
    # pygame.draw.rect(window, (255,0,0), (a+700, b-540, width+10, length+200))
    # if a < 1:
    # a = c
    # obst1 = pygame.Rect(a + 200, 100, 100, 100)
    # obst1 = pygame.draw.rect(window, (255, 0, 0), (obst1))
    ...
    if ((tcheck or keys[pygame.K_RIGHT]) and not noclip) or (keys[pygame.K_RIGHT] and noclip): #K_RIGHT = instakill with 0.0 seconds respawn time
        ...
        if tcheck and not noclip:
            time.sleep(0.5)
            print("ded spawn time complete (0.5 secs)")
    ...
    if wavehitbox.colliderect(o1) \
            or wavehitbox.colliderect(o2) \
            or wavehitbox.colliderect(o3) \
            or wavehitbox.colliderect(o4) \
            or wavehitbox.colliderect(o5) \
            or wavehitbox.colliderect(o6) \
            or wavehitbox.colliderect(o7) \
            or wavehitbox.colliderect(o8) \
            or wavehitbox.colliderect(o10) \
            or wavehitbox.colliderect(o11) \
            or wavehitbox.colliderect(o12) \
            or wavehitbox.colliderect(o13) \
            or wavehitbox.colliderect(o14) \
            or wavehitbox.colliderect(o15) \
            or wavehitbox.colliderect(o16) \
            or wavehitbox.colliderect(o17) \
            or wavehitbox.colliderect(o18) \
            or wavehitbox.colliderect(o19) \
            or wavehitbox.colliderect(o20) \
            or wavehitbox.colliderect(o21) \
            or wavehitbox.colliderect(o22) \
            or wavehitbox.colliderect(o23) \
            or wavehitbox.colliderect(o24) \
            or wavehitbox.colliderect(o25) \
            or wavehitbox.colliderect(o26) \
            or wavehitbox.colliderect(o27) \
            or wavehitbox.colliderect(o28) \
            or wavehitbox.colliderect(o29) \
            or wavehitbox.colliderect(o30) \
            or wavehitbox.colliderect(o31) \
            or wavehitbox.colliderect(o32) \
            or wavehitbox.colliderect(o33) \
            or wavehitbox.colliderect(o34) \
            or wavehitbox.colliderect(o35) \
            or wavehitbox.colliderect(o36) \
            or wavehitbox.colliderect(o37) \
            or wavehitbox.colliderect(o38) \
            or wavehitbox.colliderect(o39) \
            or wavehitbox.colliderect(o38) \
            or wavehitbox.colliderect(o39) \
            or wavehitbox.colliderect(o40) \
            or wavehitbox.colliderect(o41) \
            or wavehitbox.colliderect(o46) \
            or wavehitbox.colliderect(o47) \
            or wavehitbox.colliderect(o48) \
            or wavehitbox.colliderect(o49) \
            or wavehitbox.colliderect(o50) \
            or wavehitbox.colliderect(o51) \
            or wavehitbox.colliderect(o52) \
            or wavehitbox.colliderect(o53) \
            or wavehitbox.colliderect(o54) \
            or wavehitbox.colliderect(o54):
            tcheck = True
    ...
    if percentage < 100:
        percentage = percentage + 0.2801 #INCORRECT RATE FOR NOW
